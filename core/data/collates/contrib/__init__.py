...
def get_augment_method(
    ...
    if mode == "train" and config["augment"]:
        ...
        if "augment_method" not in config or config["augment_method"] == "NormalAug":
            ...
            trfms_list += [transforms.CenterCrop(80),
                           transforms.RandomHorizontalFlip()]
        ...
        elif config["augment_method"] == "DeepEmdAug":
            # tag: DeepEmdAug
            print("DeepEmdAug")
            image_size = 84
            trfms_list = [
...
def get_mean_std(
    ...
    if "augment_method" not in config or config["augment_method"] == "NormalAug":
        MEAN = [120.39586422 / 255.0, 115.59361427 /
                255.0, 104.54012653 / 255.0]
        STD = [70.68188272 / 255.0, 68.27635443 / 255.0, 72.54505529 / 255.0]
    elif config["augment_method"] == "S2M2Augment":
